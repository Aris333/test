...
class FaxHistoryApi extends ApiClient
{
	...
	*/
	public static function ListSentFaxes($current_page = 1, $items_per_page = 20, $array_for_api = false)
	{
	...
	*/
	...
	{
		return self::StaticApi('FaxHistory/DeleteFaxesForPeriod',array('type' => $type, 'date1' => $date1, 'date2' => $date2, 'no_trash' => $no_trash),false);
	}
	...
	*/
	...
	{
		return self::StaticApi('FaxHistory/DeleteFromListRecentRecipients',array('number' => $number),false);
	}
