...
class CommonApi extends ApiClient
{
	...
	*/
	...
	/**
	* Returns all Destinations in the given zone
	* 
	* Result includes phone number pattern (countryprefix).
	* @param int $zone Zone (Common::ListZones)
	*/
	public static function ListDestinationsForZone($zone)
	{
		return self::StaticApi('Common/ListDestinationsForZone',array('zone' => $zone),true);
	}
	...
	*/
	...
	{
		return self::StaticApi('Common/GetFormattedPrice',array('ip' => $ip),false);
	}
