      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left ftdate_div" data-parsley-validate="" id="filterby" action="<?php echo base_url("fax/filterby"); ?>/<?php echo $shorting_by; ?>" method="post">
            <input type="hidden" name="sorting_by" value="<?php echo $shorting_by; ?>">
            <input type="hidden" name="filter_by" id="filter_by_1">
              ...
              <div class="form-group" id="submitbtn_1" style="display:none; ">
                <div class="col-md-4">
            ...
            <form class="form-horizontal form-label-left" data-parsley-validate="" id="month_div" style="display:none;"action="<?php echo base_url("fax/filterby"); ?>/<?php echo $shorting_by; ?>" method="post">
            <input type="hidden" name="sorting_by" value="<?php echo $shorting_by; ?>">
            <input type="hidden" name="filter_by" id="filter_by_2">
            <div class="form-group">
               ...
               <div id="">
                  ...
                  <div class="form-group" id="submitbtn_2">
                   <div class="col-md-4">
                    <button class="btn btn-success" type="submit" id="savePromoCode">Submit</button>
                    <a href="<?php echo base_url("fax/fax_shorting/"); ?><?php echo $shorting_by; ?>" class="btn btn-primary">Reset</a>
                    </div>
              ...
              <form class="form-horizontal form-label-left" data-parsley-validate="" id="year_div" style="display:none;"action="<?php echo base_url("fax/filterby"); ?>/<?php echo $shorting_by; ?>" method="post">
               <input type="hidden" name="sorting_by" value="<?php echo $shorting_by; ?>">
               <input type="hidden" name="filter_by" id="filter_by_3">
               <div class="form-group">
                 <div id="" >
                  <label class="control-label lblalign">Year</label>
                  <div class="col-md-2">
                  ...
                  <div class="form-group" id="submitbtn_3">
                     <div class="col-md-4">
                    <button class="btn btn-success" type="submit" id="savePromoCode">Submit</button>
                    <a href="<?php echo base_url("fax/fax_shorting/"); ?><?php echo $shorting_by; ?>" class="btn btn-primary">Reset</a>
                    </div>
...
function changeFilter(sel)
{
  ...
  else
  {
    ...
    $("#month_div").css("display", "none");
    $("#year_div").css("display", "none");
    $("#submitbtn_1").css("display", "none");//
    $("#submitbtn_2").hide();//
    $("#submitbtn_3").hide();//
    //$("#filterby").hide();//
    window.location.href = "<?php base_url('fax/fax_shorting/all');  ?>";
  }
}
