    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            <br>
            <form class="form-horizontal form-label-left" data-parsley-validate="" id="editPromoCpdeForm" novalidate="" method="post" action="<?php echo base_url("promocodemaster/updatePromoCode/".$promocodeData->txtPromoID);?>">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button class="btn btn-primary" type="reset" onclick="window.location.href = '<?php echo base_url("promocodemaster"); ?>';">Cancel</button>  
