...
<div class="right_col" role="main">
  <div class="">
    <div class="page-title">
      <div class="col-md-12">
        <h3 class="pull-left">Promo code Master</h3>
        ...
        <div class="pull-right"><button onclick="window.location.href = '<?php echo base_url("promocodemaster/add"); ?>';" class="btn btn-primary " style="margin-right: 5px;"><i class="fa fa-plus"></i> Add New</button></div>
      </div>
    </div>
                    ...
                    foreach ($allPromocodes as $promocode) {
                        ...
                        <tr>
                          ...
                          <td class="actionWrapper">
                            <a href="<?php echo base_url("promocodemaster/edit/" . $promocode->txtPromoID); ?>" class="btn btn-success btn-xs editPromoLink <?php echo $hiddenEdit; ?>">Edit</a>
                            <a href="<?php echo base_url("promocodemaster/delete/" . $promocode->txtPromoID); ?>" class="btn btn-danger btn-xs removePromoLink <?php echo $hiddenRemove; ?>">Delete</a> 
                           ...
                           <!--  <a href="#" class="btn btn-primary btn-xs sendPromoLink <?php echo $hiddenSend; ?>" data-id="<?php echo $promocode->txtPromoID; ?>" data-toggle="modal" data-target="#myModal" onclick="popupSendEmail('<?php echo $promocode->txtPromoCode; ?>', '<?php echo $promocode->txtTotalCredit; ?>');">Send</a> --> 
                             ...
                             <a href="<?php echo base_url("promocodemaster/view/" . $promocode->txtPromoID); ?>" class="btn btn-info btn-xs viewPromoLink">View</a> 
                          </td>
                        </tr>
                        <?php
                        $i++;
