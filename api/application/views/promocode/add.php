        ...
        <div class="x_panel">
          <div class="x_content">
            <br>
              ...
              <form class="form-horizontal form-label-left" data-parsley-validate="" id="addPromocodeForm" novalidate="" action="<?php echo base_url("promocode/addPromo"); ?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control col-md-7 col-xs-12" readonly=""  id="startDateTimePicker" name="txtStartDate" >
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control col-md-7 col-xs-12 " readonly=""  id="endDateTimePicker" name="txtEndDate" >
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url("promocode"); ?>';">Cancel</button>
