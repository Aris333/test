  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Promo code Master View</h3>
      </div>
    </div>
<button onclick="window.location.href = '<?php echo base_url("promocodemaster"); ?>';" type="reset" class="btn btn-primary" style="float: right;">Go Back</button>
