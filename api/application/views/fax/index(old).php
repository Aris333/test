            ...
            <input type="hidden" name="sorting_by" value="<?php echo $shorting_by; ?>">
              <div class="form-group">
                ...
                <div id="date_range_div" style="display:none;">
                  ...
                  <div class="col-md-2">
                    <input type="text" name="from_date" id="from_date" placeholder="mm/dd/yyyy" class="form-control filterby">
                  </div>
                  <label class="control-label lblalign">To Date</label>
                  <div class="col-md-2">
                    <input type="text" name="to_date" id="to_date" placeholder="mm/dd/yyyy" class="form-control filterby">
                  </div>
                </div>
