...
<html lang="en">
  <head>
    ...
    <title>SpeedyFax | Admin</title>


   <link href="<?php echo base_url(); ?>assests/css/label_colour_change.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url(); ?>assests/vendors/bootstrap-datepicker/css/datepicker.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assests/css/select2.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assests/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
    <link href="<?php echo base_url(); ?>assests/css/custom.min.css" rel="stylesheet">
