...
class FaxJobApi extends ApiClient
{
	...
	*/
	public static function AddFile($filename, $origin = '', $file_size = '', $file_contentmd5 = '')
	{
		return self::StaticApi('FaxJob/AddFile',array('filename' => $filename, 'origin' => $origin, 'file_size' => $file_size, 'file_contentmd5' => $file_contentmd5),false);
	}
