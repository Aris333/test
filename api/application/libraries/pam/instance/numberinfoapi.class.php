...
class NumberInfoApi extends ApiClient
{
	...
	*/
	public function GetNumberInfo($faxnumber)
	{
		return $this->CallApi('NumberInfo/GetNumberInfo',array('faxnumber' => $faxnumber),true);
	}
	...
	*/
	public function GetPagePrice($faxnumber, $language_code = false)
	{
		return $this->CallApi('NumberInfo/GetPagePrice',array('faxnumber' => $faxnumber, 'language_code' => $language_code),true);
	}
}
