...
class FaxJobApi extends ApiClient
{
	...
	*/
	public function Create($user_ip, $user_agent, $origin)
	{
		return $this->CallApi('FaxJob/Create',array('user_ip' => $user_ip, 'user_agent' => $user_agent, 'origin' => $origin),false);
	}
	...
	* @param string $user_agent User agent string of the client device. If not available, put something descriptive (like "iPhone OS 2.2")
	*/
	public function CloneFax($uuid, $user_ip, $user_agent)
	{
		return $this->CallApi('FaxJob/CloneFax',array('uuid' => $uuid, 'user_ip' => $user_ip, 'user_agent' => $user_agent),false);
	}
	...
	*/
	public function AddRecipient($number, $name = false)
	{
		return $this->CallApi('FaxJob/AddRecipient',array('number' => $number, 'name' => $name),false);
	}
	...
	*/
	public function AddRecipients($numbers, $names = false)
	{
		return $this->CallApi('FaxJob/AddRecipients',array('numbers' => $numbers, 'names' => $names),false);
	}
	...
	* @param string $names Optional array of recipient names, lnegth must match length of numbers argument
	*/
	public function SetRecipients($numbers, $names = false)
	{
		return $this->CallApi('FaxJob/SetRecipients',array('numbers' => $numbers, 'names' => $names),false);
	}
	...
	*/
	public function ListRecipients($current_page = 1, $items_per_page = 100)
	{
		return $this->CallApi('FaxJob/ListRecipients',array('current_page' => $current_page, 'items_per_page' => $items_per_page),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('FaxJob/RemoveAllRecipients',array(),false);
	}
	...
	* @param string $number The recipients number in international format
	*/
	public function RemoveRecipient($number)
	{
		return $this->CallApi('FaxJob/RemoveRecipient',array('number' => $number),false);
	}
	...
	*/
	public function AddFile($filename, $origin = '', $file_size = '', $file_contentmd5 = '')
	{
		return $this->CallApi('FaxJob/AddFile',array('filename' => $filename, 'origin' => $origin, 'file_size' => $file_size, 'file_contentmd5' => $file_contentmd5),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('FaxJob/AddRemoteFile',array('url' => $url),false);
	}
	...
	*/
	public function AddFileFromOnlineStorage($provider, $uuid)
	{
		return $this->CallApi('FaxJob/AddFileFromOnlineStorage',array('provider' => $provider, 'uuid' => $uuid),false);
	}
	...
	*/
	public function AddAnotherFax($fax_uuid)
	{
		return $this->CallApi('FaxJob/AddAnotherFax',array('fax_uuid' => $fax_uuid),false);
	}
	...
	*/
	public function RemoveFile($file_uuid)
	{
		return $this->CallApi('FaxJob/RemoveFile',array('file_uuid' => $file_uuid),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('FaxJob/RemoveAllFiles',array(),false);
	}

	/**
	* Get all uploaded files for the current fax
	*/
	public function ListFaxFiles()
	{
		return $this->CallApi('FaxJob/ListFaxFiles',array(),false);
	}
	...
	*/
	public function SetCover($template_id = false, $text = '', $template_uuid = '*', $data = false)
	{
		return $this->CallApi('FaxJob/SetCover',array('template_id' => $template_id, 'text' => $text, 'template_uuid' => $template_uuid, 'data' => $data),false);
	}
	...
	*/
	public function SetNotifications($notifications, $group_notification = false, $error_notification = false, $save_defaults = false)
	{
		return $this->CallApi('FaxJob/SetNotifications',array('notifications' => $notifications, 'group_notification' => $group_notification, 'error_notification' => $error_notification, 'save_defaults' => $save_defaults),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('FaxJob/ResetNotifications',array(),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('FaxJob/RemoveCover',array(),false);
	}
	...
	*/
	public function ListAvailableCovers($defaults_if_empty = true)
	{
		return $this->CallApi('FaxJob/ListAvailableCovers',array('defaults_if_empty' => $defaults_if_empty),false);
	}
	...
	*/
	public function GetFaxState()
	{
		 
		return $this->CallApi('FaxJob/GetFaxState',array(),false);
	}
	...
	*/
	public function StartPreviewCreation()
	{
		return $this->CallApi('FaxJob/StartPreviewCreation',array(),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('FaxJob/GetPreview',array(),false);
	}
	...
	*/
	public function EditDelayedFax($fax_uuid, $send_at = false, $send_at_timezone = false, $datetime = false)
	{
		return $this->CallApi('FaxJob/EditDelayedFax',array('fax_uuid' => $fax_uuid, 'send_at' => $send_at, 'send_at_timezone' => $send_at_timezone, 'datetime' => $datetime),false);
	}
	...
	*/
	public function Send($send_at = false, $send_at_timezone = false, $datetime = false)
	{
		return $this->CallApi('FaxJob/Send',array('send_at' => $send_at, 'send_at_timezone' => $send_at_timezone, 'datetime' => $datetime),false);
	}
	...
	* @param string $datetime Datetime in MySql format (example, 2014-10-12 04:56:59). note! if passed, $send_at value will be ignored
	*/
	public function SendLater($send_at = false, $send_at_timezone = false, $datetime = false)
	{
		return $this->CallApi('FaxJob/SendLater',array('send_at' => $send_at, 'send_at_timezone' => $send_at_timezone, 'datetime' => $datetime),false);
	}
	...
	*/
	public function SendUnpaidFaxes($uuids)
	{
		return $this->CallApi('FaxJob/SendUnpaidFaxes',array('uuids' => $uuids),false);
	}
	...
	*/
	public function SendDelayedFaxNow($uuid)
	{
		return $this->CallApi('FaxJob/SendDelayedFaxNow',array('uuid' => $uuid),false);
	}
	...
	*/
	public function Cancel($uuid, $siblings_too = false)
	{
		return $this->CallApi('FaxJob/Cancel',array('uuid' => $uuid, 'siblings_too' => $siblings_too),false);
	}
	...
	*/
	public function SetSenderDetails($number = false, $name = false)
	{
		return $this->CallApi('FaxJob/SetSenderDetails',array('number' => $number, 'name' => $name),false);
	}
	...
	*/
	public function FaxesInProgress()
	{
		return $this->CallApi('FaxJob/FaxesInProgress',array(),false);
	}
}
