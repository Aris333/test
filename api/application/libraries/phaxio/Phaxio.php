...
require_once(dirname(__FILE__)."/PhaxioOperationResult.php");
require_once(dirname(__FILE__)."/PhaxioException.php");

class Phaxio
{
    private $debug = false;
    private $api_key = "889a71a51359a59f5bed1c6727386f487f76090c";
    private $api_secret = "63d381d917bb2b9b134a030fcb5454bdab9cbf50";
