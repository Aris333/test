...
class Credits_model extends CI_Model{
    ...
    /* use for adminpanel */
    public function unassign_country(){
   //SELECT * FROM `tblCountry` WHERE `status` = 1 AND `id` NOT IN(SELECT county_id FROM tblcredits where status=1)
